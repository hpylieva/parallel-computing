...
//      val (dist, PointsPair) = boundaryMerge(pointsMerged, leftDistance, rightDistance, splitPoint)
//      (pointsMerged, dist, pointsPair)
//    }
//  }
//
...
//  }
//
//  def boundaryMerge(points: Vector[Point], leftDistance: Double, rightDistance: Double, middlePoint: Point): (Double, PointsPair) = {
...
//    val (minBoundaryDistance, pointsPair) = getMinPointsDistance(pointsInRange)
//    (scala.math.min(minDistance, minBoundaryDistance), pointsPair)
//  }
//
//  def getMinPointsDistance(points: Vector[Point]): (Double, Point, Option[Point]) = {
//    if (points.length < 2)
//      (Double.MaxValue, points(0), None)
//    else {
//      var minDistance = Double.MaxValue
//      var closestPair = PointsPair(points(0), points(1))
//      for (i <- 0 until points.length - 1) {
//        var j = i + 1
//        while (j < i + 8 && j < points.length) {
//          val stepDistance = distance(points(i), points(j))
//          minDistance = if (stepDistance < minDistance)
//            (stepDistance, points(i), points(j))
//          else
//            (minDistance,  points(0), points(1))
//
//          j += 1
//        }
//      }
